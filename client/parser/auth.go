...
Usage: talka auth:register <controller> [options]
...
Usage: talka auth:login <controller> [options]
...
Usage: talka auth:passwd [options]
...
Usage: talka auth:cancel [options]
...
Usage: talka auth:regenerate [options]
